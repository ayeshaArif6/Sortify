# <img src="./public/dark_logo.png" alt="Sortify" width="30">  Sortify
...
```bash
 ...
 Favorites System with toggle & filter
 Dark Mode Toggle for visual comfort
 Recent Uploads & Analytics on Dashboard
 Soft Delete (Firestore-flag based)
